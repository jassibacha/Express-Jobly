...
describe('GET /companies', function () {
    ...
    test('works: GET /companies with name filter', async function () {
    ...
    test('works: GET /companies with minEmployees filter', async function () {
    ...
    test('works: GET /companies with maxEmployees filter', async function () {
    ...
    test('works: GET /companies with min & max employees filter', async function () {
    ...
    test('bad request if GET /companies with minEmployees > maxEmployees', async function () {
        const resp = await request(app).get(
    ...
    test('works: GET /companies with name and employee range filter', async function () {
        const resp = await request(app).get(
